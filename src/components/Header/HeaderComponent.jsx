...
const HeaderComponent = () => {
  ...
  return (
    <>
      <div className='bg-[#1c1c84] text-white flex justify-between items-center p-2'>
      ...
      <div className={`bg-[#1c1c84] text-white p-2 transition-all duration-300 ${isOpen ? 'h-auto' : 'h-0 overflow-hidden'}`}>
